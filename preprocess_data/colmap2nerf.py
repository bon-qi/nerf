...
def parse_args():
	...
	parser.add_argument("--time_slice", default="0,15", help="time (in seconds) in the format t1,t2 within which the images should be generated from the video. eg: \"--time_slice '10,300'\" will generate images only from 10th second to 300th second of the video")
